...
class AlbumController extends Controller
{
    public function index()
    {
        ...
        // BASE QUERY
        // biar ga redudan, jadi di join kan dulu semua fk nya
        // SQL:
        //
        // SELECT
        //     r.release_id,
        ...
        $baseQuery = DB::table('releases as r')
            ...
            ->join('artist_release as arl', function ($join) {
                $join->on('r.release_id', '=', 'arl.release_id')
                    ->where('arl.role', '=', 'Main');
            })
        ...
        //     m.year
        //
        // ORDER BY total_yang_di_koleksi DESC
        //
        // LIMIT 15

        $collecteds = (clone $baseQuery)
